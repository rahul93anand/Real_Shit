...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Restaurant_Review'
        db.create_table(u'Foodsquareapp_restaurant_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rest_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Foodsquareapp.Restaurant'])),
            ('image_name', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'Foodsquareapp', ['Restaurant_Review'])


    def backwards(self, orm):
        # Deleting model 'Restaurant_Review'
        db.delete_table(u'Foodsquareapp_restaurant_review')
